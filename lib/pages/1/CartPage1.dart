import 'package:d2d_flutter/pages/1/CheckOutPage1.dart';
...
class CartPage1 extends StatefulWidget {
  @override
  _CartPageState1 createState() => _CartPageState1();
}

class _CartPageState1 extends State<CartPage1> {
  @override
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          ...
          RaisedButton(
            onPressed: () {
              Navigator.push(context, new MaterialPageRoute(builder: (context) => CheckOutPage1()));
            },
            color: Colors.green,
