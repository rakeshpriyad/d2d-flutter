import 'package:d2d_flutter/pages/1/CartPage1.dart';
...
class ProductDetailsPage1 extends StatefulWidget {
  ...
  ProductDetailsPage1(this.heroTag);

  @override
  _ProductDetailsPageState1 createState() => _ProductDetailsPageState1(heroTag);
}

class _ProductDetailsPageState1 extends State<ProductDetailsPage1> with TickerProviderStateMixin<ProductDetailsPage1> {
  ...
  _ProductDetailsPageState1(this.heroTag);
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: IconButton(
                              ...
                              alignment: Alignment.center,
                              onPressed: () {
                                Navigator.of(context).push(new MaterialPageRoute(builder: (context) => CartPage1()));
                              },
                              iconSize: 14,
                            ),
